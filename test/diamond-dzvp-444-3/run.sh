...
cp /home/junjiey/work/fftisdf-benchmark-new/src/fft_isdf_new.py main-new.py
kernprof -l main-new.py

cp /home/junjiey/work/fftisdf-benchmark-new/src/fft_isdf.py main-old.py
kernprof -l main-old.py
