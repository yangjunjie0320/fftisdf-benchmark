...
class InterpolativeSeparableDensityFitting(FFTDF):
    ...
    def aoR_loop(self, grids=None, kpts=None, deriv=0, blksize=None):
        ...
        block_loop = ni.block_loop(
            ...
            max_memory=max_memory, blksize=blksize
            )
        
        for ao_k1_etc in block_loop:
            coords = ao_k1_etc[4]
...
if __name__ == "__main__":
    ...
    cell = cell_from_poscar(os.path.join(DATA_PATH, "nio-prim.vasp"))
