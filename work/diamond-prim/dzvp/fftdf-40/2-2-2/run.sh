...
cp /central/home/junjiey/work/fftisdf-benchmark-new/src/main-krhf-fftdf.py main.py
python main.py --ke_cutoff=40.00 --cell=diamond-prim.vasp --kmesh=2-2-2 --basis=gth-dzvp-molopt-sr --pseudo=gth-pade
