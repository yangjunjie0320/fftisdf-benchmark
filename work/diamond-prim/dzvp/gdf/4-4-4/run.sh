...
cp /central/home/junjiey/work/fftisdf-benchmark-new/src/main-krhf-gdf.py main.py
python main.py --cell=diamond-prim.vasp --kmesh=4-4-4 --basis=gth-dzvp-molopt-sr --pseudo=gth-pade
