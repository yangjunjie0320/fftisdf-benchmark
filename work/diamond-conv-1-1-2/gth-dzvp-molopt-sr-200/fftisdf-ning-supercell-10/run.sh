...
cp /home/junjiey/work/fftisdf-benchmark//src/main-fftisdf-ning-supercell.py main.py


export PYSCF_EXT_PATH=$HOME/packages/pyscf-forge/pyscf-forge-yangjunjie-non-orth/
cp /home/junjiey/work/fftisdf-benchmark//src/main-fftisdf-ning-supercell.py main.py
python main.py --c0=10.00 --cell=diamond-conv.vasp --kmesh=1-1-2 --basis=gth-dzvp-molopt-sr --ke_cutoff=200.00 --pseudo=gth-pade 
